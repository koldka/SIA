...
public:
    ...
    virtual Vector3f is(const Normal3f normal, Vector3f i ) const = 0;
...
public:
   ...
   virtual Vector3f is(const Normal3f normal, Vector3f i ) const  {return Vector3f(0.0);}
   Color3f premultBrdf(const Vector3f& viewDir, const Vector3f& lightDir, const Normal3f& normal, const Vector2f& uv) const{return diffuseColor(uv) * INV_PI;}
...
public:
    ...
    std::string toString() const;
    virtual Vector3f is(const Normal3f normal, Vector3f i )const ;
